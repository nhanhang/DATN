...
pinMode(2, OUTPUT);
  ...
  Serial.println("oke");
    printText("Starting up",RED,14,50,2);
...
void loop() {
  ...
  if (success) {
    ...
    ID1 = String(uidString);
     unsigned long longID = strtoul(ID1.c_str(), NULL, 10);
     Serial.println(longID);
 ...
 tttiem= extractData(data);
      ...
      delay(1000);
       ...
       PutData(firebaseHost,"display",String(longID));
        delay(3000);
